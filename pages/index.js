  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold">Antiquariato Italiano</h1>
          <p className="text-gray-600">Marketplace per antiquari e collezionisti</p>
        </div>
        <div className="flex gap-2">
          <input placeholder="Cerca oggetto o città" className="border p-2 rounded w-full sm:w-64" />
          <button className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Cerca</button>
        </div>
      </header>
